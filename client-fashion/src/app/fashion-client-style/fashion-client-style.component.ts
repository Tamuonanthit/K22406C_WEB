...
@Component({
  selector: 'app-fashion-client-style',
  templateUrl: './fashion-client-style.component.html',
  styleUrl: './fashion-client-style.component.css'
})
export class FashionClientStyleComponent {
