...
@Component({
  selector: 'app-fashion-admin-update',
  templateUrl: './fashion-admin-update.component.html',
  styleUrl: './fashion-admin-update.component.css'
})
export class FashionAdminUpdateComponent {
